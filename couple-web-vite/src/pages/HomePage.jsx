...
const PHOTO_DATA = [
  { url: "mb1.jpg", caption: "วันแรกที่เราเจอกัน ❤️" },
  { url: "mb2.jpg", caption: "ทริปทะเลแสนหวาน 🌊" },
  { url: "mb3.jpg", caption: "ดินเนอร์สุดพิเศษของเรา ✨" },
  { url: "mb4.jpg", caption: "ขอบคุณที่อยู่ข้างกันนะ 💖" },
  { url: "mb5.jpg", caption: "รักเธอที่สุดในโลกเลย 🌍" },
];
